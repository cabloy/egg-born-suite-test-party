export default {
  ...
  PartyExpenseInfo: 'Party Expense Info',
  ...
  F7AboutTip4:
    "CabloyJS pioneered the layout strategy of 'PC = Mobile + Pad', bringing the user experience and development experience of Framework7 into the PC scene",
  ...
  'Select Single Atom': 'Select Single Data',
  'Select Multiple Atoms': 'Select Multiple Data',
};
