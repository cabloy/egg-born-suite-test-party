<template>
  <eb-page @page:afterin="onPageAfterIn">
    ...
    <f7-block strong>
      <p>
        Menu component is designed to be used as overlay control. It can be very helpful when you need controls on top
        of the map, images, some text/code editor, etc.
      </p>
    </f7-block>
        ...
        <f7-menu-item style="margin-left: auto" icon-f7="::share" dropdown>
          <f7-menu-dropdown right>
            <f7-menu-dropdown-item href="#">
              ...
              <f7-icon class="margin-left" f7=":social:facebook"></f7-icon>
            </f7-menu-dropdown-item>
            <f7-menu-dropdown-item href="#">
              <span>Share on Twitter</span>
              <f7-icon class="margin-left" f7=":social:twitter"></f7-icon>
            </f7-menu-dropdown-item>
          </f7-menu-dropdown>
        </f7-menu-item>
        <f7-menu-item href="#" icon-f7="::edit"></f7-menu-item>
    ...
    <f7-card>
      <f7-card-content :padding="false">
        ...
        <f7-menu style="position: absolute; left: 0px; top: 6px">
          <f7-menu-item href="#" icon-f7="::zoom-in"></f7-menu-item>
          <f7-menu-item href="#" icon-f7="::zoom-out"></f7-menu-item>
          <f7-menu-item icon-f7="::layers" dropdown>
            <f7-menu-dropdown left>
...
export default {
  ...
  methods: {
    ...
    initMap() {
      const self = this;
      const mymap = window.L.map(self.$refs.map, { zoomControl: false }).setView([51.505, -0.09], 10);
      window.L.tileLayer(
