<template>
  <eb-page>
    ...
    <f7-block strong>
      <p>
        Framework7 comes with ultimate modular Color Picker component that allows to create color picker with limitless
        combinations of color modules.
      </p>
    </f7-block>
      ...
      >
        <i
          ...
          :style="`background-color: ${
            rgbaPickerValue.rgba ? `rgba(${rgbaPickerValue.rgba.join(', ')})` : rgbaPickerValue.hex
          }`"
    ...
    <f7-block-header
      >RGB sliders with labels and values in Popover, and previous and current color values blocks</f7-block-header
    >
    <f7-list no-hairlines-md>
      <f7-list-input
        type="colorpicker"
    ...
    <f7-block-header
      >Current Color + HSB Sliders + RGB sliders + Alpha Slider + HEX + Palette with labels and editable
      values</f7-block-header
    >
    <f7-list no-hairlines-md>
      <f7-list-input
        type="colorpicker"
