  ...
  <eb-page>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('basicProcess')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('backendConfigI18N')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('frontendConfigI18N')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('backendDatabase')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('backendDatabaseTransaction')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
    ...
    <f7-card>
      <f7-card-header>
        ...
        <div>
          <f7-link :external="true" target="_blank" :href="getUrl('menuAuthorization')">{{
            $text('How to do ...')
          }}</f7-link>
        </div>
      </f7-card-header>
  ...
  methods: {
    ...
    onPerformClick6() {
      return this.$api.post('kitchen-sink/guide/echo6').then(data => {
        this.message6 = window.JSON5.stringify(data, null, 2);
      });
    },
    onPerformClick7() {
    ...
    onPerformClick8() {
      return this.$api.post('kitchen-sink/guide/echo8').then(data => {
        this.message8 = window.JSON5.stringify(data, null, 2);
      });
    },
    onPerformClick9() {
